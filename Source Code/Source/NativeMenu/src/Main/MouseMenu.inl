...
constexpr int MenuTabOrder[MenuTabCount]={0,1,3,5,13,4,10,9,11,12,14,6,7,2,15};
...
bool MenuAdjustable(int page,int row){return (page==5&&row>=3&&row<=5)||(page==14&&row==6)||(page==11&&(row==0||row==4))||(page==12&&(row==0||row==1))||(page==1&&row==1)||(page==3&&((row>=1&&row<=3)))||(page==4&&(row==2||row==3||row==9||row==10))||(page==6&&row>=4&&row<=6)||(page==7)||(page==9&&(row==3||row==4||row==7));}
