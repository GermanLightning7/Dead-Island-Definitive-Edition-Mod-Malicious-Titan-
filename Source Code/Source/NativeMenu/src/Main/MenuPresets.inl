...
void Init(){if(!settings.empty())return;
 ...
 Bool("esp",espEnabled);Bool("esp_boxes",espBoxesEnabled);Bool("esp_skeletons",espSkeletonsEnabled);Bool("esp_snaplines",espSnaplinesEnabled);Bool("esp_health",espHealthEnabled);Bool("esp_distance",espDistanceEnabled);Bool("player_tracker",PlayerTracker::enabled);
 ...
 const LONG normalTheme[6]={(LONG)0xF20A0612,(LONG)0xFFF3ECFF,(LONG)0xFF6B3FA0,(LONG)0xFF3D2359,(LONG)0xFF2A1640,(LONG)0xFFCEAAFF};
