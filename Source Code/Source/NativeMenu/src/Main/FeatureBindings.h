...
constexpr int rowCounts[]={5,8,2,5,11,7,9,9,0,12,5,5,3,9,10,4,7};
...
{"SILENT AIM","FOV LIMIT","FOV RADIUS","TARGET PRIORITY","TARGET MARKER","TARGET SNAPLINE","CAMERA LOCK-ON KEY","LOCK-ON TARGET SOURCE","SPINBOT","SPIN SPEED","AIM BODY PART"},
