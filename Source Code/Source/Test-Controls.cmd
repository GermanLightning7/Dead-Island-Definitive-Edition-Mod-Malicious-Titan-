...
pushd ..\Builds
cl /nologo /O2 /MD /W3 /EHsc /std:c++17 /DWIN32_LEAN_AND_MEAN /DNOMINMAX /I"%MH%\include" /I"%MH%\src" ..\Source\test_special.cpp "%MH%\src\buffer.c" "%MH%\src\hook.c" "%MH%\src\trampoline.c" "%MH%\src\hde\hde64.c" /link /OUT:test_special.exe user32.lib advapi32.lib d3d11.lib dxgi.lib d3dcompiler.lib dxguid.lib gdi32.lib shell32.lib
if errorlevel 1 exit /b 1
test_special.exe
exit /b %errorlevel%
