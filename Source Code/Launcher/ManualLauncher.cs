...
public static class Core {
 ...
 public static void ValidateFiles(string game){
  if(!File.Exists(Path.Combine(game,@"Jenta_Special_Edition/Native/DideMeleeDurability.dll"))||FileHash(Path.Combine(game,@"Jenta_Special_Edition/Native/DideMeleeDurability.dll"))!="bc6d0f08377ee3509307576267e8aeccf0d0c34c14a3165a3ec72229a77d317c")throw new Exception("Manual package file missing or changed: Jenta_Special_Edition/Native/DideMeleeDurability.dll");
  if(!File.Exists(Path.Combine(game,@"Jenta_Special_Edition/Native/DideMeleeNative.dll"))||FileHash(Path.Combine(game,@"Jenta_Special_Edition/Native/DideMeleeNative.dll"))!="5e61e93f4a5ab3e78a45544474609e36a98020fccbc38c146ba5d912266ea5d0")throw new Exception("Manual package file missing or changed: Jenta_Special_Edition/Native/DideMeleeNative.dll");
  if(!File.Exists(Path.Combine(game,@"Jenta_Special_Edition/Native/JentaSpecialEdition.dll"))||FileHash(Path.Combine(game,@"Jenta_Special_Edition/Native/JentaSpecialEdition.dll"))!="fe4d05b811a06cd51de0a332345e407bfd8e41d7aa124c5f90ed6021784e715c")throw new Exception("Manual package file missing or changed: Jenta_Special_Edition/Native/JentaSpecialEdition.dll");
