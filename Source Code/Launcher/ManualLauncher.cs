...
public static class Core {
 ...
 public static void ValidateFiles(string game){
  if(!File.Exists(Path.Combine(game,@"Jenta_Special_Edition/Native/DideMeleeDurability.dll"))||FileHash(Path.Combine(game,@"Jenta_Special_Edition/Native/DideMeleeDurability.dll"))!="edc04b58777465b8a3d22247cca498be78397d660c038a249171ee36a84e012b")throw new Exception("Manual package file missing or changed: Jenta_Special_Edition/Native/DideMeleeDurability.dll");
  if(!File.Exists(Path.Combine(game,@"Jenta_Special_Edition/Native/DideMeleeNative.dll"))||FileHash(Path.Combine(game,@"Jenta_Special_Edition/Native/DideMeleeNative.dll"))!="c060f4389fe03877bf2c5d877479484b62c090a30f79aeb7fc9f14e2e5c173a8")throw new Exception("Manual package file missing or changed: Jenta_Special_Edition/Native/DideMeleeNative.dll");
  if(!File.Exists(Path.Combine(game,@"Jenta_Special_Edition/Native/JentaSpecialEdition.dll"))||FileHash(Path.Combine(game,@"Jenta_Special_Edition/Native/JentaSpecialEdition.dll"))!="c13c7419a50563bd6a0200b642c10d5e9c53b60bf746c347a777a99328a81caa")throw new Exception("Manual package file missing or changed: Jenta_Special_Edition/Native/JentaSpecialEdition.dll");
